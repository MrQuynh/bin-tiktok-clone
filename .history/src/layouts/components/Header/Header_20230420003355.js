...
function Header() {
    ...
    // change styles mode
    const state.modalRedux ==="light", sestate.modalRedux ==="light"] = useState(false);
    useEffect(() => {
        if (state.modalRedux === 'dark') {
    ...
    //         rootStyles.setProperty('--white', 'black');
    //         rootStyles.setProperty('--black', 'white');
    //         sestate.modalRedux ==="light"(true);
    //     } else {
    //         sestate.modalRedux ==="light"(false);
