...
const userMenu = [
    {
        ...
        title: <FormattedMessage id="search.profile" />,
        to: '/quynhhh',
    },
    {
    ...
    ...MENU_ITEMS,
    {
        ...
        title: <FormattedMessage id="search.logout" />,
        // to: '/',
        separate: true,
    },
];
                ...
                <div className={cx('actions')}>
                    ...
                    {currentUser?.status ? (
                        <>
                            ...
                            <Tippy delay={[0, 50]} content={<FormattedMessage id="search.inbox" />} placement="bottom">
                                <button className={cx('action-btn')}>
                                    <InboxIcon />
