...
const linkLogo =
    'https://www.google.com/url?sa=i&url=https%3A%2F%2Fnewsroom.tiktok.com%2Fvi-vn%2Ftiepnoihanhtrinhsangtao-2020&psig=AOvVaw116d1sDYmOozNBZeQ5Wewa&ust=1663841210594000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCLi3tNbRpfoCFQAAAAAdAAAAABAD';
const linkImage1 =
        ...
        <header className={cx('wrapper')}>
            ...
            <div className={cx('inner')}>
                <Link to="/" className={cx('logo-link')}>
                    {!isDark ? (
                        <Image className={cx('logo-image')} src={linkLogo} alt="TikTok" />
                    ) : (
