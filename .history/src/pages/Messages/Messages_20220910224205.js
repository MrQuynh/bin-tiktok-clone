...
function Messages() {
    ...
    console.log(state.messageAuthorList);
    console.log(window.onkeypress(23));
    return (
            ...
            <div className={cx('body-container')}>
                <div className={cx('conversation-list')}>
                    ...
                    <div className={cx('list-content')}>
                        ...
                        {state.currentUser ? (
                            ...
                            <div className={cx('no-message')}>No messages yet</div>
                        )}
                    </div>
                </div>
                <div className={cx('chat-box')}>
                    ...
                    <div className={cx('chat-box-main')}>
                        <MessageUser dataUser={state.currentUser} text="Who are you?" />
                        {state.messageAuthorList.map((messageText, index) => (
