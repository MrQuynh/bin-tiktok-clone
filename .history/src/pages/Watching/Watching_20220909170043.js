...
function Watching() {
    ...
    const handleGetListComments = () => {
        const uuidVideo = linkVideo.uuid.slice(1, linkVideo.uuid.length - 1);
        // const uuidVideo = '703f037e-5902-41fd-abe6-a98c59b2a043'
        console.log(uuidVideo);

        uuidVideo && userService.getListComments(uuidVideo).then((data) => console.log(data));
    };
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('author')}>
                ...
                <div className={cx('comments')} onClick={handleGetListComments}>
                    <UserComment />
                    <UserComment />
                    <UserComment />
                </div>
