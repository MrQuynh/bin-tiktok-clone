...
function UserComment({ itemCmts }) {
    ...
    // console.log('time now:', d.getDate());
    // console.log('time create:', itemCmts.created_at.split(' ')[0].split('-')[2]);
    console.log(itemCmts);
    return (
        <div className={cx('wrapper')}>
            <div className={cx('info')}>
                ...
                <div className={cx('actions')}>
                    ...
                    <div className={cx('actions-delete')}>Delete</div>
