...
function Watching() {
    ...
    // get list video watching of an user
    // useEffect(() => {
    //     anUserService
    //         .getAVideoOfUser(+idLink)
    //         .then((data) => {
    //             // console.log(data);
    //             // if (data[0]) {
    //             //     setLinkVideo(data[0]);
    ...
    // useEffect(() => {
    //     let indexVideo;
    //     const find = state.listVideoWatchingRedux.find((item, index) => item.id == idVideo);
    //     console.log('find', find);
    // }, [idVideo]);
    // console.log('okok', state.listVideoWatchingRedux);
    const handleChangeVideo = () => {
        const listVideoRedux = state.listVideoWatchingRedux;
        // let indexVideo = 0;
        console.log(idVideo);
        console.log(listVideoRedux);
        console.log(
            'id',
            listVideoRedux.findIndex((item) => item.id == idVideo),
        );
        // listVideoRedux.map((item, index) => {
        //     if (item.id === idVideo) {
        //         indexVideo = index;
        //     }
        // });
        // if (indexVideo === listVideoRedux.length - 1) {
        //     indexVideo = 0;
        // } else {
        //     indexVideo++;
        // }
        // setIdVideo(listVideoRedux[indexVideo].id);
        // console.log('id', listVideoRedux[indexVideo].id);
    };
